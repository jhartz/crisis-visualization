...
function Zoom(map, container, buttons, infoElem) {
    this.datamap = map;
...
Zoom.prototype.listen = function() {
    for (var i = 0; i < this.buttons.length; i++) {
        this.buttons[i].addEventListener("click", this._handleClick.bind(this), false);
    }
...
Zoom.prototype._handleClick = function(event) {
    var direction = event.target.getAttribute("data-zoom");
...
Zoom.prototype._shift = function(direction) {
    ...
    var translate = this.d3Zoom.translate(), translate0 = [], l = [];
    var view = {
        x: translate[0],
        y: translate[1],
        k: this.d3Zoom.scale()
